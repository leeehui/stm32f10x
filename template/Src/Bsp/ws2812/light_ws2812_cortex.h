...
#define ws2812_port_set ((uint32_t*)&WS2812_PORT->BSRR)	// Address of the data port register to set the pin
#define ws2812_port_clr	((uint32_t*)&WS2812_PORT->BRR)	// Address of the data port register to clear the pin
